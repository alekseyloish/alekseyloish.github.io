...
jQuery(function ($) {
	...
	var contact = {
		message: null,
		init: function () {
			$('.banner-box a.call-me').click(function (e) {
				e.preventDefault();
					...
					dialog.data.fadeIn(200, function () {
						$('#contact-container .contact-content').animate({
							...
							$('#contact-container form').fadeIn(200, function () {
                                $("#contact-container #contact-phone").mask("+7 999 999 99 99", {placeholder: "x"});
                            ...
                            $('#contact-container .contact-title-h').fadeIn(200);
						});
					});
				});
			});
		...
		show: function (dialog) {
			$('#contact-container .contact-send').click(function (e) {
				...
				if (contact.validate()) {
                    ...
                    $('#contact-container .contact-title-h').fadeOut(200);
